...
#define RED_NODE DT_ALIAS(pwm_led1)
#define GREEN_NODE DT_ALIAS(pwm_led2)
#define BLUE_NODE DT_ALIAS(pwm_led0)
...
static int pwm_set(struct device const *pwm_dev, uint32_t pwm_pin,
